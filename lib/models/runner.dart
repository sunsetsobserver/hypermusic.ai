...
class Runner {
  ...
  void _decompose(
    ...
    for (var dimId = 0; dimId < feature.getCompositesCount(); dimId++) {
      ...
      final subfeature = feature.getComposite(dimId);
      if (subfeature == null) continue;
  ...
  List<int> _generateSubfeatureSpace(
    ...
    if (dimId >= feature.getCompositesCount()) {
